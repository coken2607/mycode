package com.example.atn.curved;
...
public class CurvedBottomNavigation extends BottomNavigationView {
    ...
    public CurvedBottomNavigation(Context context) {
        super(context);
//        CURVE_CIRCLE_RADIUS = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 56,
//                context.getResources().getDisplayMetrics());
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mFirstCurveStartPoint.set(
                (navigationBarWidth / 2) - (CURVE_CIRCLE_RADIUS * 2) - (CURVE_CIRCLE_RADIUS),
                0);
        ...
        mPath.cubicTo(mFirstCurveControlPoint1.x, mFirstCurveControlPoint1.y,
                mFirstCurveControlPoint2.x, mFirstCurveControlPoint2.y, mFirstCurveEndPoint.x,
                mFirstCurveEndPoint.y);

        mPath.cubicTo(mSecondCurveControlPoint1.x, mSecondCurveControlPoint1.y,
                mSecondCurveControlPoint2.x, mSecondCurveControlPoint2.y, mSecondCurveEndPoint.x,
                mSecondCurveEndPoint.y);
